...
<header class="site-header shadow-sm">
    <div class="topbar bg-dark text-white py-2">
        <div class="container d-flex justify-content-between align-items-center flex-wrap gap-2">
            <small><i class="fa fa-map-marker-alt"></i> <span class="lang-en">Allama Iqbal Road, Street 4, Mian Channu</span><span class="lang-ur" style="display:none;">علامہ اقبال روڈ، سٹریٹ 4، میاں چنّو</span></small>
            <div class="d-flex gap-3 align-items-center">
                <a href="tel:+923001234567" class="text-white"><i class="fa fa-phone"></i> +92 300 1234567</a>
                <a href="mailto:info@muzammillacecenter.com" class="text-white"><i class="fa fa-envelope"></i> <span class="lang-en">info@muzammillacecenter.com</span></a>
                <button id="langToggle" class="btn btn-sm btn-light ms-2" title="Toggle Urdu/English"><i class="fa fa-globe"></i> اردو/EN</button>
            </div>
        </div>
    </div>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container">
            <a class="navbar-brand text-maroon fw-bold" href="index.php">Muzammil Lace Center</a>
            ...
            <div class="collapse navbar-collapse" id="mainMenu">
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <?php if (is_logged_in()): ?>
                        <li class="nav-item"><a class="nav-link" href="account.php"><span class="lang-en">Account</span><span class="lang-ur" style="display:none;">اکاؤنٹ</span></a></li>
                    <?php else: ?>
                        <li class="nav-item"><a class="nav-link" href="login.php"><span class="lang-en">Login</span><span class="lang-ur" style="display:none;">لاگ ان</span></a></li>
                    <?php endif; ?>
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="wishlist.php"><i class="fa fa-heart"></i> <span class="badge bg-gold text-dark"><?php echo $wishCount; ?></span></a>
                    </li>
                    <li class="nav-item position-relative">
                        <a class="nav-link" href="cart.php"><i class="fa fa-shopping-cart"></i> <span class="badge bg-maroon text-white"><?php echo $cartCount; ?></span></a>
                    </li>
                </ul>
            </div>
        </div>
